<template>
  <section class="section-wrapper">
    ...
    <div class="section-info">
      <span>A seguir, algumas tecnologias que tenho experiências de uso:</span>
    </div>
    <div class="section-icons">
      ...
      <div class="section-icon">
        <svg viewBox="0 0 128 128" id="github-bg">
